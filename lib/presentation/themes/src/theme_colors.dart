...
class ThemeColors extends ThemeExtension<ThemeColors> {
  ...
  static get dark => const ThemeColors(
        authButtonFill: DarkAppColors.indigo,
        formFieldFill: DarkAppColors.blueGrey,
        infoCardBackground: DarkAppColors.darkGrey,
        roadmapCardBackground: DarkAppColors.darkIndigo,
        navButtonHover: DarkAppColors.grey,
        webButtonFillColor: DarkAppColors.transparent,
        menuOpacity: DarkAppColors.transparent,
        ...
        productsPartnersSectionBackground: DarkAppColors.darkGrey,
        incomeSectionBackground: DarkAppColors.darkIndigo,
        joinButtonBorder: DarkAppColors.indigo,
        partnersCardBackground: DarkAppColors.darkIndigo,
        partnersCardContentBackground: DarkAppColors.grey,
        careServiceButton: DarkAppColors.grey,
        referralBonusCell: DarkAppColors.darkIndigo,
        faqItemBorderHovered: DarkAppColors.transparent,
        faqItemArrowFill: DarkAppColors.indigo,
        productsPartnersSectionArrowButton: DarkAppColors.white,
        productsPartnersSectionCardBackground: DarkAppColors.grey,
        productsPartnersSectionCardShadow: DarkAppColors.black,
        blogPostBorder: DarkAppColors.blueGrey,
        blogPostBorderHovered: DarkAppColors.indigo,
        blogPostBackground: DarkAppColors.darkGrey,
        askButtonBackground: DarkAppColors.grey,
        partnerButtonBorder: DarkAppColors.white,
        postShadow: DarkAppColors.black,
        postBackground: DarkAppColors.darkGrey,
        promotionSectionCardBackground: DarkAppColors.darkGrey,
        homeAskButtonBorder: DarkAppColors.indigo,
        homeInvestmentSectionArrow: DarkAppColors.white,
        homeInvestmentSectionDivider: DarkAppColors.white,
        homeInvestmentChipBorder: DarkAppColors.white,
        revenueSectionDivider: DarkAppColors.grey,
        ...
        directionCardIcon: DarkAppColors.indigo,
        ...
        dashboardSideMenuSelectedItem: DarkAppColors.indigo,
        dashboardSideMenuUnselectedItem: DarkAppColors.blueGrey,
        greyish: DarkAppColors.greyish,
        profilePageError: DarkAppColors.red,
        profilePageAboveBackground: DarkAppColors.black,
        profilePageBackground: DarkAppColors.darkGrey,
        profilePagePrimary: DarkAppColors.indigo,
        profilePagePrimaryVariant: DarkAppColors.darkIndigo,
