...
class ThemeColors extends ThemeExtension<ThemeColors> {
  ...
  static get dark => ThemeColors(
        ...
        incomeSectionBackground: AppColors.lighterIndigo,
        joinButtonBorder: DarkAppColors.white,
        partnersCardBackground: AppColors.lightIndigo,
        partnersCardContentBackground: DarkAppColors.grey,
        careServiceButton: DarkAppColors.grey,
        referralBonusCell: AppColors.lighterIndigo,
        faqItemBorderHovered: DarkAppColors.transparent,
        faqItemArrowFill: DarkAppColors.white,
        ...
        blogPostBorderHovered: DarkAppColors.white,
        ...
        homeAskButtonBorder: DarkAppColors.white,
